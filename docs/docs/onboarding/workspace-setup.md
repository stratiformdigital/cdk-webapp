...
If you've had errors along the way, that's OK! We're here to help. If you've successfully joined our Slack channel, feel free to post there.  Else, please send an email to {{ site.contact_url }} explaining the issue. We will get back to you ASAP.
